...
def main():
    ...
    if  args.ifenv==0:
        engine.model.load_state_dict(torch.load(args.save+"_env5"+".pth"))
        print("start finetuning...",flush=True)
    else:
    ...
    for iter, (x, y) in enumerate(dataloader['test_loader'].get_iterator()):
        ...
        testx = testx.transpose(1,3)
        with torch.no_grad():
            preds,trend,season = engine.model(testx)
    ...
    torch.save(engine.model.state_dict(), args.save+'_env'+str(args.env)+".pth")
